...
export const ui: Record<Lang, UIStrings> = {
  ...
  en: {
    ...
    resume: {
      ...
      summaryP1: "After completing a master's degree at Chiba University Graduate School, Design Science, I joined JVCKENWOOD Design, where I worked on the design and development of exhibition applications, vision concepts for major car manufacturers, and R&D with TouchDesigner. I then joined PickNote as a UI/UX designer and front-end engineer, building a new service from scratch.",
      summaryP2: 'In October 2020, I joined M3, Inc. As a product designer on "M3 DigiKar," the No. 1 cloud-based EHR by market share, I owned design, product management, and recruiting end to end, leading the business\'s growth from 2,000 to 10,000 medical facilities. I currently serve as General Manager of a new-products team, driving multiple new products in parallel — AI agent development, Next DigiKar, IC Platform, a pharmacy dispensing system, and an automated AI video generation system.',
      ...
      str2Label: 'Cross-Functional Engagement', str2Body: 'I embed myself in the field across design, engineering, product management, customer success, sales, and management — translating between perspectives to drive projects forward.',
      str3Label: 'Initiative in the Face of Uncertainty', str3Body: "Zero-to-one, 1 → 10, 10 → 100 — at every phase, I'm the first to step into the unknown. I believe nothing beats learning through practice.",
      secVision: 'Vision', visionLead: 'Bringing product design to the front lines of business decision-making.',
      visionText: 'I want to connect the user perspective and the business perspective in a shared language, and create environments where designers thrive as a discipline that moves the business. By using AI to its fullest and redesigning productivity for both organizations and individuals, I want to help draw what society looks like next.',
      secCareerOverview: 'Work Experience — Overview', secCareerDetail: 'Work Experience — Details', periodLabel: 'Tenure: ',
      secSkills: 'Skills', secEdu: 'Education & Languages', langLabel: 'Languages', langValue: 'Japanese (native) / English (reading & writing)',
